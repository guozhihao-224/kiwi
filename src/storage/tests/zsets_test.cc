...
TEST_F(ZSetsTest, ZPopMaxTest) {
  ...
  storage::Status s = db.ZAdd("GP1_ZPOPMAX_KEY", gp1_sm, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(4, ret);
...
// ZRank
// TEST_F(ZSetsTest, ZRankTest) {  // NOLINT
//   int32_t ret, rank;
...
// TODO(@tangruilin): 修复测试代码
// ZRevrangebyscore
// TEST_F(ZSetsTest, ZRevrangebyscoreTest) {  // NOLINT
//   int32_t ret;
//   std::vector<storage::ScoreMember> score_members;
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -1000.000000000001, std::numeric_limits<double>::max(),
// true,
...
//   &score_members); ASSERT_TRUE(s.ok()); ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001,
// "MM18"},
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -999999999, -1000.000000000001 , true, true,
// &score_members);
//   ASSERT_TRUE(s.ok());
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -999999999, -1000.000000000001 , true, false,
// &score_members);
//   ASSERT_TRUE(s.ok());
